...
public class SeekBarActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this는 implement로 리스너가 달려있는 클래스
    ...
    public void onStartTrackingTouch(SeekBar seekBar) {
        ...
        switch (id){
            case R.id.seekBar:
                text1.setText("첫 번째 seekbar를 터치");
                break;
            case R.id.seekBar2:
                text2.setText("두 번째 seekbar를 터치");
                break;
        }
    }
    //값을 변경하기 위해서 seekbar에 터치를 끝낼 때
    @Override
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        switch (id){
            case R.id.seekBar:
                ...
                break;
            case R.id.seekBar2:
                text2.setText("두 번째 seekbar를 터치 종료");
                break;
        }
    }
}
